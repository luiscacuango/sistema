...
public class ManagedBeanReportando implements Serializable {
    ...
    public void addInfoCaja(ActionEvent actionEvent) {
        SimpleDateFormat fecha1 = new SimpleDateFormat("EEEEE dd MMMMM yyyy");
        String cadena_fecha1 = fecha1.format(fecha_cierre_caja);
        FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "El cierre de Caja para el día : ", cadena_fecha1 + "  Se realizó correctamente."));
    }
...
//this.generateFileList(new File(SOURCE_FOLDER));
    ...
    public void generar_almacenes() {
        ...
        try {
            ...
            parameters.put("id_tienda", idTienda);
